...
exports.PackedJob = void 0;
const fileJob_1 = require("./fileJob");
const folderJob_1 = require("./folderJob");
const jobProperty_1 = require("./jobProperty");
const tmp = require("tmp"), fs = require("fs"), path = require("path"), JSZip = require("jszip"), _ = require("lodash"), Reflect = require("reflect-metadata");
class PackedJob extends fileJob_1.FileJob {
    constructor(e, job) {
    ...
    extractFiles(zip, single, zipPath, callback, totalFiles) {
        let pj = this;
        let tmpobj = tmp.dirSync();
...
//# sourceMappingURL=packedJob.js.map